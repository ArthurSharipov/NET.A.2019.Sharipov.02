...
существует.
3. Реализовать метод FilterDigit который принимает список целых чисел и
...
7, FilterDigit (7,1,2,3,4,5,6,7,68,69,70, 15,17) -&gt; {7, 70, 17}.
4. Реализовать алгоритм FindNthRoot, позволяющий вычислять корень n-ой
